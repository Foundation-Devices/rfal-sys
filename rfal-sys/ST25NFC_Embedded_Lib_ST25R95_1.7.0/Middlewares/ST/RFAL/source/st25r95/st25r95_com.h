 ...
 *  \return RFAL_ERR_NONE    : Operation successful
 *  \return RFAL_ERR_TIMEOUT : Timeout
 *  \return RFAL_ERR_PARAM   : ProtocolSelect failure
 *
 *****************************************************************************
 */
 ...
 *
 *  \return RFAL_ERR_NONE            : Operation successful
 *  \return RFAL_ERR_NOT_IMPLEMENTED : unsupported bit rate value
 *
 *****************************************************************************
 */
 ...
 *
 *  \return RFAL_ERR_NONE    : Data ready to be read
 *  \return RFAL_ERR_TIMEOUT : No data available
 *
 *****************************************************************************
 */
 ...
 *  
 *  \return RFAL_ERR_NONE    : ST25R95 ready to receive data
 *  \return RFAL_ERR_TIMEOUT : ST25R95 not ready to receive data
 *
 *****************************************************************************
 */
